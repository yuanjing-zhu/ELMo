...
class Instance_(object):
    """
    class for a single line of data, collecting columns
    """
    def __init__(self, column_name_list, feature_name_list):
        self.data = {}
        self.init_data_structure(column_name_list, feature_name_list)

    def init_data_structure(self, column_name_list, feature_name_list):
        for column in column_name_list:
            self.data[column] = {}
            for feature in feature_name_list:
                self.data[column][feature] = []

    def get_data(self, column, feature, value):
        self.data[column][feature] = value
